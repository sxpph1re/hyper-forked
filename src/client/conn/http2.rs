...
impl Builder {
    ...
    pub fn max_concurrent_streams(&mut self, sz: impl Into<Option<u32>>) -> &mut Self {
    ...
    pub fn max_header_list_size(&mut self, sz: impl Into<Option<u32>>) -> &mut Self {
    ...
    pub fn enable_push(&mut self, sz: impl Into<Option<bool>>) -> &mut Self {
    ...
    ///
    /// Passing `None` will do nothing.
    pub fn header_table_size(&mut self, sz: impl Into<Option<u32>>) -> &mut Self {
